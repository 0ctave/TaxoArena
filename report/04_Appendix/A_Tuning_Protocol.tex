...
artifacts on 2026-07-27. The addendum records that the null-arm
artifacts sat in an untracked build directory --- a caveat it carries
as written; they have since been committed
(\texttt{experiment\_results/rubric\_null/},
Section~\ref{sec:res-rubric-null}).
