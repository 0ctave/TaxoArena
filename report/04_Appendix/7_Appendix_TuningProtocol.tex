...
Chapter~\ref{ch:results} can be checked. The purpose of reproducing
...
\todo[inline]{This document is stale as written: it still records
``treatment arm only, no null, this is not yet evidence''. The null arm
has since been run and the result was never written back. Amend it,
with the amendment dated, before reproducing its text here. Also
resolve the band ambiguity: two pre-registrations state different
decision bands and neither says whether they govern the same
quantity.}
