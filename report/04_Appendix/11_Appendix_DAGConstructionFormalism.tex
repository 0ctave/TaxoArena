...
(Section~\ref{subsec:polyhierarchy}), so
...
second parent $h$. Candidates were scored by how many of $h$'s
...
The measurements that retired the operator, and the single-parent
invariant that replaced it, are in Section~\ref{sec:poly-negative}.
