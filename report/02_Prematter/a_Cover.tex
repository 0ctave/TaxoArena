	...
	%------------------------------		
		...
		\begin{titlepage}
			\begin{center}
				...
				% LOGO
				%------------------------------
				% The template ships a second letterhead (Logo_dbta) for Fachgebiet
				% Dynamik und Betrieb technischer Anlagen. This work was done at
				% Fachgebiet Verteilte Systeme und Betriebssysteme (DOS), which the
				% \mydepartment line below already names, so the dbta letterhead is
				% not included: it would put two different Fachgebiete on one page.
				\includegraphics[trim={2cm 2cm 2cm 2cm}, clip, height=2.1cm]{Logo_tub}
				%------------------------------
				% TITLE AND AUTHOR INFORMATION
				%------------------------------
