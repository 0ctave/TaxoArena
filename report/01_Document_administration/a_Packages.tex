...
\usepackage[
	...
	textformat=simple,		% every caption already ends in a full stop of its
							% own; textformat=period appends a second one
							% unconditionally, which rendered all 28 captions
							% with ".." (checked 2026-07-31)
