...
% DIRECTORIES
%------------------------------
\setcounter{secnumdepth}{3}	% 3, not 4: numbering \paragraph produced TOC artifacts like 3.3.1.0.1 when a paragraph sits directly under a subsection
...
\DeclareUnicodeCharacter{1D57}{\ensuremath{^\intercal}}
...
\DeclareUnicodeCharacter{2C7C}{\ensuremath{_v}}