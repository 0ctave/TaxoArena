...
absolute rank-fidelity figure quoted to three decimals; the sampler and
tie-convention sensitivity of Section~\ref{sec:res-tie-policy} rules
that out, and only paired contrasts within a run are reported as such.
