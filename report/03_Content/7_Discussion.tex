...
reasons unrelated to the evaluation mechanism---a validity threat
that flatters the headline metric.
...
leaf-specific rubric---partially disciplines this threat, and the
scope of that control must be stated precisely.
