...
object TaxoPrompts {
    ...
    fun clusterLabeling(
        ...
        val siblings = if (siblingLabels.isEmpty()) "None (First sub-domain)" else siblingLabels.joinToString(", ")
        ...
        return """
            ...
            2. Constraint: The label must be a concise noun phrase (2-3 words).
            ...
            5. Forbidden: Do not use "General", "Misc", "Miscellaneous", "Other", or "Advanced".
    ...
    fun superDomainSynthesis(subjects: List<String>): String {
        ...
        return """
            ...
            - If subjects are (Anatomy, Virology, Medicine) -> "Biological and Health Sciences"
